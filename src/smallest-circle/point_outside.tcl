# point_outside.tcl --
#     Draw a small set of points with circles and one point in the top
#
...
# Point in the top ...
set y [expr {200 * sqrt(3)/2.0}]
.c create oval [expr {250-5}] [expr {250-5-$y}] [expr {250+5}] [expr {250+5-$y}] -fill cyan
.c create arc  50             [expr { 50-$y}]   450            [expr {450  -$y}] -style arc -start 220 -extent 100

after 1000 {
    set pdf1 [::pdf4tcl::new %AUTO% -paper {4.2c 4.2c}]
    $pdf1 canvas .c -width 4.2c
    $pdf1 write -file point_outside.pdf
}
