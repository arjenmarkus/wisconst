...
set x 0
while {$x < 600} {
    .c create line $x 250 $x 150 [expr {$x+100}] 150 [expr {$x+100}] 250 [expr {$x+200}] 250 -width 3
    set x [expr {$x + 200}]
}
.c create line $x 250 $x 150 [expr {$x+50}] 150 -width 3


after 1000 {
    set pdf1 [::pdf4tcl::new %AUTO% -paper {9.5c 4.5c}]
    $pdf1 canvas .c -width 9.2c
    $pdf1 write -file simple-curve1.pdf
}
